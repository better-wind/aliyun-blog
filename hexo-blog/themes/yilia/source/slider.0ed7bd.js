...
/***/ function(module, exports, __webpack_require__) {
	...
	var _star = __webpack_require__(110);
	...
	if (!isMobile) {
		// Anm.init()
		_star2.default.init(180, 1000, 180);
	} else {
		_star2.default.init(window.innerHeight * .8, 500, window.innerHeight * .8 * .8);
	}
...
/***/ function(module, exports) {
	 ...
	 * 画布实例
	 * */
	var starSky = function starSky(width, height, stars, splitHeight) {
	  this.width = width;
	  this.height = height;
	  this.stars = stars;
	...
	Star.prototype = {
	  ...
	  randomPoint: function randomPoint() {
	    var _x = Math.random() * SkySetting.width,
	        ...
	        _y = _ran > 2 ? Math.random() * this.splitHeight : Math.random() * this.height,
	 ...
	 * 构造星空实例
	 * */
	var init = function init(height, stars, splitHeight) {
	  var sky = new starSky(SkySetting.width, height, stars, splitHeight);
	  sky.start();
	};
	module.exports = {
	  init: init
